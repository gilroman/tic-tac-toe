...
describe AI do    
    ...
    it 'getBestMove should return a value of type integer' do
        ...
        activePlayerName = 'O'
        board = Board.new
        board.board = [0, 1, 'X', 'X', 'O', 5, 'O', 'O', 8]

        ai.miniMax(board, activePlayerName)
        move =  ai.getBestMove
    ...
    it 'minimax should return 100 if the computer has won' do
        ...
        activePlayerName = 'O'
        board = Board.new
        board.board = ['X', 'X', 'O', 3, 'O', 'X', 'O', 7, 8]
        
        score = ai.miniMax(board, activePlayerName)
